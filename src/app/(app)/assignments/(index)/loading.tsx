// =============================================================================
// Loading state for /assignments — the student's assignment list.
// -----------------------------------------------------------------------------
...
//
// `(index)` route group: /assignments/[weekId] and
// /assignments/[weekId]/submit both `notFound()` for a week with no assignment.
// A boundary on the /assignments segment would cover both. Scoped here instead.
// =============================================================================
