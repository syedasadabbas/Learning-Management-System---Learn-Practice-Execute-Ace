// =============================================================================
// Loading state for /learn/[track]/[moduleSlug] — one stepped module.
// -----------------------------------------------------------------------------
...
//
// Guarded from ./layout.tsx, which resolves the module (and checks it really
// belongs to the [track] in the path) above this boundary.
// =============================================================================
