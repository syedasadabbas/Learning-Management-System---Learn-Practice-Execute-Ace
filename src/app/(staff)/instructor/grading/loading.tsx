// =============================================================================
// Loading state for /instructor/grading — the submission queue.
// -----------------------------------------------------------------------------
...
//
// Its own boundary, not the parent's: a boundary at /instructor would already be
// mounted by the time the sidebar click swaps `grading` in, and an already-mounted
// Suspense boundary does not re-show. The heaviest read a staff member makes.
// =============================================================================
