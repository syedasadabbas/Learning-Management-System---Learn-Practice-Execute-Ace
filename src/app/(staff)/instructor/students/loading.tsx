// =============================================================================
// Loading state for /instructor/students — per-student progress.
// -----------------------------------------------------------------------------
...
//
// Own boundary, per the note in ../loading.tsx: an ancestor boundary does not
// re-fire on a sibling swap.
// =============================================================================
