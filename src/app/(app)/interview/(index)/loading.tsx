// =============================================================================
// Loading state for /interview — the interview drill browser.
// -----------------------------------------------------------------------------
...
//
// `(index)` route group: /interview/[slug] 404s for an unknown slug and for a
// PRACTICE-bank slug, so that /interview/js-sum cannot quietly render a practice
// problem under the wrong ladder. Same shape as /problems, same reason.
// =============================================================================
