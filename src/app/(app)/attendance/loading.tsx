// =============================================================================
// Loading state for /attendance — staff attendance and participation marking.
// -----------------------------------------------------------------------------
...
//
// Reachable from the instructor sidebar but living under (app), not (staff) —
// the penalties-attendance stream shipped it there. No dynamic children and no
// `notFound()` below, so a plain leaf boundary is correct.
// =============================================================================
