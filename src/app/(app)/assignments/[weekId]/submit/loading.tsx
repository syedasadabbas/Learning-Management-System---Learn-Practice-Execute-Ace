// =============================================================================
// Loading state for /assignments/[weekId]/submit — the stand-in submit page.
// -----------------------------------------------------------------------------
...
//
// Guarded from ../layout.tsx, which is ABOVE this boundary and already refuses
// a week with no assignment. The `notFound()` calls still in this route's own
// page are therefore unreachable rather than wrong, and are left in place as
// defence in depth — if this boundary or that layout is ever moved, they are the
