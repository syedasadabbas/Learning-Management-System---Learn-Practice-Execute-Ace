// =============================================================================
// Loading state for /problems/[slug] — one practice problem.
// -----------------------------------------------------------------------------
...
//
// Guarded from ./layout.tsx, which resolves the problem through the `cache()`d
// `loadProblem` so the guard and the page share one lookup. That matters more
// here than anywhere else: `loadProblem` is four sequential round trips, roughly
// a second, and an unmemoised guard would have doubled it.
// =============================================================================
