// =============================================================================
// Loading state for /leaderboard — cohort standings.
// -----------------------------------------------------------------------------
...
//
// Covers /leaderboard/me as well, which is safe: neither route calls
// `notFound()`. At 993 ms for the per-week query (scripts/perf-probe.ts) this is
// among the two pages the skeleton was built for.
// =============================================================================
